 ...
 */
export function instanceOfProjectUpdate(value) {
...
export function ProjectUpdateFromJSON(json) {
    return ProjectUpdateFromJSONTyped(json, false);
}
export function ProjectUpdateFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function ProjectUpdateToJSON(json) {
    return ProjectUpdateToJSONTyped(json, false);
}
export function ProjectUpdateToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
