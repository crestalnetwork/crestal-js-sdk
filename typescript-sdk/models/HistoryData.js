 ...
 */
export function instanceOfHistoryData(value) {
    return true;
}
export function HistoryDataFromJSON(json) {
    return HistoryDataFromJSONTyped(json, false);
}
export function HistoryDataFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function HistoryDataToJSON(json) {
    return HistoryDataToJSONTyped(json, false);
}
export function HistoryDataToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
