 ...
 */
export function instanceOfDAInfoResource(value) {
    return true;
}
export function DAInfoResourceFromJSON(json) {
    return DAInfoResourceFromJSONTyped(json, false);
}
export function DAInfoResourceFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function DAInfoResourceToJSON(json) {
    return DAInfoResourceToJSONTyped(json, false);
}
export function DAInfoResourceToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
