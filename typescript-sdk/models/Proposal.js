 ...
 */
export function instanceOfProposal(value) {
    return true;
}
export function ProposalFromJSON(json) {
    return ProposalFromJSONTyped(json, false);
}
export function ProposalFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function ProposalToJSON(json) {
    return ProposalToJSONTyped(json, false);
}
export function ProposalToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
